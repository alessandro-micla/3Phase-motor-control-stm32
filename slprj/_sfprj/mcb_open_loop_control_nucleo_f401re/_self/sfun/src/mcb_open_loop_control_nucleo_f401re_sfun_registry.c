...
{
  extern unsigned int
    sf_mcb_open_loop_control_nucleo_f401re_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_mcb_open_loop_control_nucleo_f401re_process_check_sum_call(nlhs,plhs,
       nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_mcb_open_loop_control_nucleo_f401re_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "mcb_open_loop_control_nucleo_f401re") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_mcb_open_loop_control_nucleo_f401re_third_party_uses_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_mcb_open_loop_control_nucleo_f401re_jit_fallback_info
  ...
  if (strcmp(machineName, "mcb_open_loop_control_nucleo_f401re") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_mcb_open_loop_control_nucleo_f401re_jit_fallback_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_mcb_open_loop_control_nucleo_f401re_get_post_codegen_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "mcb_open_loop_control_nucleo_f401re") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_mcb_open_loop_control_nucleo_f401re_get_post_codegen_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_mcb_open_loop_control_nucleo_f401re_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "mcb_open_loop_control_nucleo_f401re") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_mcb_open_loop_control_nucleo_f401re_updateBuildInfo_args_info(nlhs,
      plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "mcb_open_loop_control_nucleo_f401re") == 0) {
    ...
    newRhs[2] = prhs[3];
    return
      sf_mcb_open_loop_control_nucleo_f401re_get_eml_resolved_functions_info
      (nlhs,plhs,3,newRhs);
  }
...
extern unsigned int sf_mcb_open_loop_control_nucleo_f401re_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"mcb_open_loop_control_nucleo_f401re")) {
    return(sf_mcb_open_loop_control_nucleo_f401re_method_dispatcher(simstructPtr,
...
extern void mcb_open_loop_control_nucleo_f401re_terminator(void);
void sf_machine_global_terminator(SimStruct* S)
{
  (void)S;
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    mcb_open_loop_control_nucleo_f401re_terminator();
  }

  return;
}

extern void mcb_open_loop_control_nucleo_f401re_initializer(void);
...
void sf_machine_global_initializer()
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    mcb_open_loop_control_nucleo_f401re_initializer();
  }
